...
bool CTable::SendTableData(uint32_t chairId, uint8_t subId, uint8_t const* data, size_t len, bool record /* = true */) {
...
bool CTable::SendUserData(std::shared_ptr<IPlayer> const& player, uint8_t subId, uint8_t const* data, size_t len, bool record) {
