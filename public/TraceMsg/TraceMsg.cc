...
#define MY_SUBID_CLIENT_TO_HALL_MAP(XX) \
	...
	XX(::Game::Common::MESSAGE_CLIENT_TO_HALL_SUBID::CLIENT_TO_HALL_LOGIN_MESSAGE_REQ, "登陆大厅REQ", LVL_DEBUG) \
	XX(::Game::Common::MESSAGE_CLIENT_TO_HALL_SUBID::CLIENT_TO_HALL_LOGIN_MESSAGE_RES, "登陆大厅RSP", LVL_DEBUG) \
	XX(::Game::Common::MESSAGE_CLIENT_TO_HALL_SUBID::CLIENT_TO_HALL_GET_GAME_ROOM_INFO_REQ, "*** 查询游戏房间列表REQ", LVL_WARN) \
	XX(::Game::Common::MESSAGE_CLIENT_TO_HALL_SUBID::CLIENT_TO_HALL_GET_GAME_ROOM_INFO_RES, "*** 查询游戏房间列表RSP", LVL_WARN) \
...
#define MY_SUBID_CLIENT_TO_GAME_SERVER_MAP(XX) \
	...
	XX(::GameServer::SUBID::SUB_C2S_ENTER_ROOM_REQ, "进入房间REQ", LVL_DEBUG) \
	XX(::GameServer::SUBID::SUB_S2C_ENTER_ROOM_RES, "进入房间RSP", LVL_DEBUG) \
	...
	XX(::GameServer::SUBID::SUB_C2S_USER_READY_REQ, "用户准备REQ", LVL_DEBUG) \
	XX(::GameServer::SUBID::SUB_S2C_USER_READY_RES, "用户准备RSP", LVL_DEBUG) \
	XX(::GameServer::SUBID::SUB_C2S_USER_LEFT_REQ, "用户离开REQ", LVL_DEBUG) \
	XX(::GameServer::SUBID::SUB_S2C_USER_LEFT_RES, "用户离开RSP", LVL_DEBUG) \
