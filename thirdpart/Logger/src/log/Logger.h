...
#ifdef _windows_
#define SynFatalf_pure(fmt,...) LOG(PARAM_FATAL, F_PURE|F_SYNC, fmt, ##__VA_ARGS__); _LOG_WAIT()
#else
#define SynFatalf_pure(args...) LOG(PARAM_FATAL, F_PURE|F_SYNC, ##args); _LOG_WAIT()
#endif

#define SynFatal_pure(msg) LOG_S(PARAM_FATAL, F_PURE|F_SYNC, msg); _LOG_WAIT()
