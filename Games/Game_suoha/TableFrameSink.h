...
//配置文件
#define INI_FILENAME "./conf/Suoha_config.ini"
//#define INI_CARDLIST "./conf/Suoha_cardList.ini"
...
protected:
	...
	//玩家牌型分析结果
	SUOHA::CGameLogic::handinfo_t all_[GAME_PLAYER], show_[GAME_PLAYER], cover_[GAME_PLAYER], show4_[GAME_PLAYER];
	int cardsCount_;
